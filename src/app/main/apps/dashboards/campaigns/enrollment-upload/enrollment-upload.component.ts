...
@Component({
    selector     : 'enrollment-upload-dialog',
    templateUrl  : './enrollment-upload.component.html',
    styleUrls    : ['./enrollment-upload.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations   : fuseAnimations
})
export class EnrollmentUploadDialogComponent implements OnInit, OnDestroy
{
    // Private
     ...
     */
    constructor(
        public matDialogRef: MatDialogRef<EnrollmentUploadDialogComponent>,
